...
class DatabaseConfig:
    def __init__(self):
        ...
        self.MONGODB_URL = os.getenv("MONGODB_URL", "mongodb://admin:adminpassword@localhost:27017/")
        self.DATABASE_NAME = "DHT_ENDPOINT"
        self.client = None
        self.database = None
    ...
    async def connect_to_mongo(self):
        ...
        try:
            ...
            print("📝 Data will be logged to terminal only (no database storage)")
            self.is_connected = False
            return False
